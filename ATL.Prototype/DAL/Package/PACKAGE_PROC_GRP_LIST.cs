...
namespace DAL.Package
{
    public class PACKAGE_PROC_GRP_LIST
    {
        ...
        {
            return OracleHelper.SelectedToIList<PACKAGE_PROC_GRP_LIST_Entity>(PubConstant.ConnectionString, CommandType.Text,
            @"
SELECT
        PROC_GRP_ID,
        PACKAGE_NO,
...
FROM (SELECT
        ...
        FROM (  SELECT 
                    ...
                    UPDATE_USER,
                    TO_CHAR (UPDATE_DATE, 'MM/DD/YYYY HH24:MI:SS') UPDATE_DATE
                FROM PACKAGE_PROC_GRP_LIST ) T1,          
            (  SELECT COUNT (1) TOTAL FROM PACKAGE_PROC_GRP_LIST ) T3
...
" + queryStr, new[]{
        ...
        public List<PACKAGE_PROC_GRP_LIST_Entity> GetDataByPackageId(string PACKAGE_NO, string VERSION_NO, string FACTORY_ID, string queryStr)
        {
            return OracleHelper.SelectedToIList<PACKAGE_PROC_GRP_LIST_Entity>(PubConstant.ConnectionString, CommandType.Text, @"
SELECT
        PROC_GRP_ID,
...
SELECT COUNT (1)
  FROM PACKAGE_PROC_GRP_LIST
 WHERE PROC_GRP_ID=:PROC_GRP_ID AND PACKAGE_NO=:PACKAGE_NO AND VERSION_NO=:VERSION_NO AND FACTORY_ID=:FACTORY_ID AND PROCESS_ID=:PROCESS_ID AND GROUP_NO=:GROUP_NO
",
                new[]{
            ...
            return OracleHelper.ExecuteNonQuery(PubConstant.ConnectionString, CommandType.Text,
                @"
INSERT INTO PACKAGE_PROC_GRP_LIST (
        PROC_GRP_ID,
        PACKAGE_NO,
        VERSION_NO,
        FACTORY_ID,
...
", new[]{
        ...
        public int PostEdit(PACKAGE_PROC_GRP_LIST_Entity entity)
        {
            return OracleHelper.ExecuteNonQuery(PubConstant.ConnectionString, CommandType.Text,
                @"
UPDATE PACKAGE_PROC_GRP_LIST SET 
...
", new[]{
        ...
        public int PostDelete(PACKAGE_PROC_GRP_LIST_Entity entity)
        {
            return OracleHelper.ExecuteNonQuery(PubConstant.ConnectionString, CommandType.Text,
@"
DELETE FROM PACKAGE_PROC_GRP_LIST 
WHERE
    PROC_GRP_ID=:PROC_GRP_ID AND 
    PACKAGE_NO=:PACKAGE_NO AND 
    VERSION_NO=:VERSION_NO AND 
...
", new[]{
        ...
        public int DeleteByGRP(PACKAGE_PROC_GRP_LIST_Entity entity)
        {
            return OracleHelper.ExecuteNonQuery(PubConstant.ConnectionString, CommandType.Text,
@"
DELETE FROM PACKAGE_PROC_GRP_LIST 
...
", new[]{
        ...
        public int DeleteByPackageId(PACKAGE_PROC_GRP_LIST_Entity entity)
        {
            return OracleHelper.ExecuteNonQuery(PubConstant.ConnectionString, CommandType.Text,
@"
DELETE FROM PACKAGE_PROC_GRP_LIST 
