<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PRODUCT_PROC_TYPE_LIST.aspx.cs" Inherits="Web.BaseInfo.PRODUCT_PROC_TYPE_LIST" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="/BaseInfo/PRODUCT_PROC_TYPE_LIST.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<table id="Table_PRODUCT_PROC_TYPE_LIST"></table>
<div id="Dialog_PRODUCT_PROC_TYPE_LIST"  class="easyui-dialog" data-options="title:'对话框',modal:false,width:500,height:400,closed:true" style="padding: 10px;">
    <table cellspacing="0" cellspadding="0">
        ...
        <tr>
            <td style="text-align: right;">PRODUCT_PROC_TYPE_NAME</td>
            <td><input type="text" id="PRODUCT_PROC_TYPE_NAME" />(少于20个字) </td>
        </tr>
        <tr>
            <td style="text-align: right;">PRODUCT_PROC_TYPE_DESC</td>
            <td><input type="text" id="PRODUCT_PROC_TYPE_DESC" />(少于25个字) </td>
        </tr>
        <tr>
