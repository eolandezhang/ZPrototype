...
{
    public class MATERIAL_PN_PARA_INFOController : ApiController
    {
        BLL.BaseInfo.MATERIAL_PN_PARA_INFO _MATERIAL_PN_PARA_INFO = new BLL.BaseInfo.MATERIAL_PN_PARA_INFO();
        #region 查询
        ...
        public List<MATERIAL_PN_PARA_INFO_Entity> GetDataPage(decimal pageSize, decimal pageNumber)
        {
