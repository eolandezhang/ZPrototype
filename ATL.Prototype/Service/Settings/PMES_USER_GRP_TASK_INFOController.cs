...
{
    public class PMES_USER_GRP_TASK_INFOController : ApiController
    {
        BLL.Settings.PMES_USER_GRP_TASK_INFO _PMES_USER_GRP_TASK_INFO = new BLL.Settings.PMES_USER_GRP_TASK_INFO();
        #region 查询
        ...
        public List<PMES_USER_GRP_TASK_INFO_Entity> GetDataPage(decimal pageSize, decimal pageNumber)
        {
