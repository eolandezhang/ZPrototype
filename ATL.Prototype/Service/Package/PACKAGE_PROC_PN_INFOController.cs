...
{
    public class PACKAGE_PROC_PN_INFOController : ApiController
    {
        BLL.Package.PACKAGE_PROC_PN_INFO _PACKAGE_PROC_PN_INFO = new BLL.Package.PACKAGE_PROC_PN_INFO();
        #region 查询
        ...
        public List<PACKAGE_PROC_PN_INFO_Entity> GetDataPage(decimal pageSize, decimal pageNumber)
        {
        ...
        {
            return _PACKAGE_PROC_PN_INFO.PostAdd(entity);
        }
