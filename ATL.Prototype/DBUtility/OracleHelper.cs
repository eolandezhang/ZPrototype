...
namespace DBUtility
{
    ...
    {     
        ...
        public static List<T> SelectedToIList<T>(string connectionString, CommandType cmdType, string cmdText, OracleParameter[] paramters) where T : new()
        {
            List<T> Result = null;
            IDataReader dr = ExecuteReader(connectionString,cmdType,cmdText,paramters);
            DynamicBuilder<T> dynamic;
            dynamic = DynamicBuilder<T>.CreateBuilder(dr);
            Result = dr.GetIListEntity<T>(dynamic.Build);
            dr.Close();
            return Result;
        }
        /// <summary>
        ...
        public static OracleParameter MakeInParam(string paramName, OracleType dbType, int size, object inValue)
        {
            return MakeParam(paramName, dbType, size, ParameterDirection.Input, inValue);
        }
        public static OracleParameter MakeInParam(string paramName, OracleType dbType, object inValue)
        {
